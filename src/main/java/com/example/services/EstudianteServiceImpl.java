...
public class EstudianteServiceImpl implements EstudianteService {
    ...
    /**
     * Esta clase para poder trabajar necesita una dependencia de 
     * Dao por lo que creamos un objeto de este tipo
     * Utilizamos autowired para inyectar esta dependencia cuando nos haga falta
     */
